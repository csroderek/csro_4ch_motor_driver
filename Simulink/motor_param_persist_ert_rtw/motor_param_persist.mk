...
PRODUCT_NAME              = motor_param_persist
MAKEFILE                  = motor_param_persist.mk
...
MODELREF_LINK_RSPFILE     = motor_param_persist_ref.rsp
CMD_FILE                  = motor_param_persist.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/motor_param_persist.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR)/motor_param_persist_ert_rtw/referenced_model_includes -I$(START_DIR) -I$(START_DIR)/motor_param_persist_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(START_DIR)/slprj/ert/_sharedutils
...
DEFINES_STANDARD = -DMODEL=motor_param_persist -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/motor_param_persist_ert_rtw/motor_param_persist.c
...
%.obj : $(START_DIR)/motor_param_persist_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
...
motor_param_persist.obj : $(START_DIR)/motor_param_persist_ert_rtw/motor_param_persist.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
