...
C_SRCS += \
../Csro/fnd_eeprom/ee.c 

OBJS += \
./Csro/fnd_eeprom/ee.o 

C_DEPS += \
./Csro/fnd_eeprom/ee.d 


# Each subdirectory must supply rules for building sources it contributes
Csro/fnd_eeprom/%.o: ../Csro/fnd_eeprom/%.c Csro/fnd_eeprom/subdir.mk
...
clean: clean-Csro-2f-fnd_eeprom

clean-Csro-2f-fnd_eeprom:
	-$(RM) ./Csro/fnd_eeprom/ee.d ./Csro/fnd_eeprom/ee.o

.PHONY: clean-Csro-2f-fnd_eeprom
